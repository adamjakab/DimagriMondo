    ...
    <ul class="btn-social clearfix">
        <?php if ($enabled["facebook_like"]): ?>
            <li class="li-social li-social-facebook li-social-facebook-like">
                <div class="fb-like" data-href="<?php print $link; ?>" data-layout="button_count" data-action="like"
        ...
        <?php if ($enabled["facebook_share"]): ?>
            <li class="li-social li-social-facebook li-social-facebook-share">
                <div class="fb-share-button" data-href="<?php print $link; ?>" data-layout="button_count"
                     data-size="small" data-mobile-iframe="true">
                    <a class="fb-xfbml-parse-ignore" target="_blank"
                       href="https://www.facebook.com/sharer/sharer.php?u=<?php print $link_encoded; ?>&amp;src=sdkpreparse">Condividi</a>
                </div>
            </li>
        <?php endif; ?>
        ...
        <?php if ($enabled["facebook_page"]): ?>
            <li class="li-social li-social-facebook li-social-facebook-page">
                <div class="fb-page" data-href="https://www.facebook.com/DimagriMondo" data-tabs="timeline"
        ...
        <?php if ($enabled["twitter"]): ?>
            <li class="li-social li-social-twitter">
                <a href="http://twitter.com/share" class="twitter-share-button" data-url="<?php print $link; ?>"
        ...
        <?php if ($enabled["pinterest"]): ?>
            <li class="li-social li-social-pinterest">
                <a href="http://pinterest.com/pin/create/button/?url=<?php print $link; ?>" class="pin-it-button"
