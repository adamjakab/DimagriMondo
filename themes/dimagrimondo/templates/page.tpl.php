    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <?php if (!empty($site_name)): ?>
                <a class="name navbar-brand txt-brand <?php print $navbar_brand_classes; ?>"
...
<?php if (!empty($page['parallax_top'])): ?>
    <div class="wrapper-parallax parallax-top container-fluid">
        <div class="row">
            <?php print render($page['parallax_top']); ?>
        </div>
    </div>
<?php endif; ?>
...
<?php if (!empty($page['parallax_bottom'])): ?>
    <div class="wrapper-parallax parallax-bottom container-fluid">
        <div class="row">
            <?php print render($page['parallax_bottom']); ?>
        </div>
    </div>
<?php endif; ?>
